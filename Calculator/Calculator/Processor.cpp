...
void Processor::CreateTxtWindow(Main* main)
{
	wxFont font(25, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false);
	text = new wxTextCtrl(main, wxID_ANY, "", wxPoint(10, 10), wxSize(320, 60), wxTE_RIGHT);
	text->SetFont(font);
}

void Processor::ButtonClick(wxCommandEvent& evt)
{
	if (evt.GetId() == 99)
	{
		// Backspace/Clear
